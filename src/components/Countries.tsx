  ...
  return (
    <Paper className={classes.root}>
      <Table className={classes.table}>
        <TableHead>
              <TableRow>
                <TableCell numeric>Sijoitus</TableCell>
                <TableCell>Name</TableCell>
                <TableCell numeric>Väestönmäärä</TableCell>
                <TableCell numeric>Osuus</TableCell>
              </TableRow>
        </TableHead>
        <TableBody>
            ...
            {maat.map(maa => {
              return (
                <TableRow key={maa.id}>
                <TableCell numeric>{maa.position}</TableCell>
                  <TableCell component="th" scope="row">
                    {maa.name}
                  </TableCell>
                  <TableCell numeric>{maa.population}</TableCell>
                  <TableCell numeric>{maa.percentage}</TableCell>
                </TableRow>
              );
            })}
          </TableBody>
